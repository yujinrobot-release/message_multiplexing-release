Name:           ros-indigo-mm-radio
Version:        0.2.4
Release:        0%{?dist}
Summary:        ROS mm_radio package
...
%description
Multiplexing many packet types across a two-way radio connection with publishers
and subscribers. Great for embedded connections by two-way serial or ethernet
types.
